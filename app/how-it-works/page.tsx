...
export default function HowItWorksPage() {
  const steps = [
    ...
    ["07", "Evolve with the community", "Phase 2 adds verified holder voting for characters, maps, and upgrades, plus creator-published AI versions with every prior frozen build preserved."],
  ];
